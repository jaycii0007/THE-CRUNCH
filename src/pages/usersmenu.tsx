...
const RECIPES: Record<string, Recipe[]> = {
  Chicken: [
    ...
    },
    {
      ...
      nutrition: { calories: 310, protein: 13, fats: 22, carbs: 80 },
      price: 328,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
    },
    ...
    },
    {
      id: 20,
      name: "1 pc. Chicken",
      description: "Solo Rice Meal. Choice of Original or Spicy.",
      image: "https://bit.ly/4r5rfZI",
      nutrition: { calories: 260, protein: 22, fats: 12, carbs: 30 },
      price: 80,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
      variant: "original",
    },
    {
      id: 21,
      name: "2 pcs. Chicken",
      description: "Rice Meal. Choice of Original or Spicy.",
      image: "https://bit.ly/4r5rfZI",
      nutrition: { calories: 420, protein: 38, fats: 22, carbs: 40 },
      price: 135,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
      variant: "original",
    },
    {
      ...
      description: "Rice Meal. Choice of Original or Spicy.",
      image: "https://bit.ly/4r1CAtC",
      nutrition: { calories: 580, protein: 52, fats: 30, carbs: 50 },
      price: 185,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
      tag: "Must Try",
    ...
    },
    {
      id: 23,
      name: "Chicken Skin",
      description: "Rice Meal. Crispy and flavorful chicken skin.",
      image: "https://bit.ly/3P6DcAK",
      nutrition: { calories: 310, protein: 18, fats: 24, carbs: 20 },
      price: 70,
      maxFlavors: 1,
      mealTypes: ["Breakfast", "Lunch"],
    },
    {
      id: 24,
      name: "Chicken Shots",
      description: "Rice Meal. Bite-sized crispy chicken shots.",
      image: "https://bit.ly/40Z9n7T",
      nutrition: { calories: 290, protein: 20, fats: 18, carbs: 25 },
      price: 75,
      maxFlavors: 1,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
  ...
  Drinks: [
    {
      ...
      description: "Chilled to perfection — bright, citrusy, slightly creamy.",
      image: "https://tinyurl.com/56rwyuj8",
    ...
    },
    {
      ...
      description: "Refreshing fruit soda. Bright and sweet.",
      image: "https://tinyurl.com/3ccde5sv",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      ...
      description: "Refreshing fruit soda. Tangy and sweet.",
      image: "https://tinyurl.com/mrydynur",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      id: 32,
      name: "Kiwi Fruit Soda",
      description: "Refreshing fruit soda. Bright and citrusy.",
      image: "https://shorturl.at/sBHbi",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      id: 33,
      name: "Lychee Fruit Soda",
      description: "Refreshing fruit soda. Floral and sweet.",
      image: "https://shorturl.at/RuKTf",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      ...
      description: "Refreshing fruit soda. Tropical and juicy.",
      image: "https://shorturl.at/MvNpm",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      ...
      description: "Refreshing fruit soda. Rich and berry-forward.",
      image: "https://shorturl.at/PbnDy",
      nutrition: { calories: 120, protein: 0, fats: 0, carbs: 30 },
      price: 70,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
  ...
  Burger: [
    {
      id: 8,
      name: "The Crunch Burger",
      description:
        "Crispy chicken on a toasted bun with fresh lettuce & tangy sauce.",
      image:
        "https://i.pinimg.com/736x/d4/38/09/d4380931a50783483fc53d55209245e1.jpg",
    ...
    {
      id: 40,
      name: "The Crunch Burger with Cheese",
      description: "Crispy chicken burger topped with a melted cheese slice.",
      image:
        "https://i.pinimg.com/736x/d4/38/09/d4380931a50783483fc53d55209245e1.jpg",
      nutrition: { calories: 560, protein: 24, fats: 21, carbs: 68 },
      price: 85,
      mealTypes: ["Breakfast", "Lunch"],
      tag: "Must Try",
    },
  ...
  Chips: [
    {
      ...
      description:
        "Evenly seasoned — rich, savory, and impossible to put down.",
      image:
        "https://i.pinimg.com/736x/a4/a5/cd/a4a5cd6b777e7bb789ee02288b6eb4d2.jpg",
  ...
  Sides: [
    {
      id: 50,
      name: "Kimchi",
      description: "Traditional fermented kimchi.",
      image: "https://bit.ly/47bPoX5",
      nutrition: { calories: 40, protein: 2, fats: 0, carbs: 8 },
      price: 45,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
    },
    {
      id: 51,
      name: "Fishcake",
      description: "Savory fishcake slices.",
      image: "https://bit.ly/4s9ZvUC",
      nutrition: { calories: 120, protein: 10, fats: 5, carbs: 12 },
      price: 85,
      mealTypes: ["Lunch", "Dinner"],
    },
    {
      id: 52,
      name: "Tteokbokki",
      description: "Chewy rice cakes in a spicy-sweet sauce.",
      image: "https://bit.ly/3MMEeRT",
      nutrition: { calories: 210, protein: 6, fats: 3, carbs: 42 },
      price: 85,
      mealTypes: ["Lunch", "Dinner"],
    },
    {
      id: 53,
      name: "Classic Chicken Skin Bucket",
      description: "Bucket of crispy classic chicken skin.",
      image: "https://bit.ly/3P6DcAK",
      nutrition: { calories: 520, protein: 28, fats: 38, carbs: 10 },
      price: 140,
      mealTypes: ["Lunch", "Dinner"],
      tag: "Must Try",
    },
    {
      id: 54,
      name: "Flavored Chicken Skin Bucket",
      description: "Bucket of crispy flavored chicken skin.",
      image: "https://bit.ly/3P6DcAK",
      nutrition: { calories: 530, protein: 28, fats: 39, carbs: 12 },
      price: 140,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
    },
    {
      id: 55,
      name: "Chicken Shots Bucket",
      description: "Bucket of bite-sized crispy chicken shots.",
      image: "https://bit.ly/40Z9n7T",
      nutrition: { calories: 620, protein: 42, fats: 32, carbs: 30 },
      price: 160,
      maxFlavors: 1,
      mealTypes: ["Lunch", "Dinner"],
    },
    {
      id: 56,
      name: "Twister Fries",
      description: "Seasoned spiral-cut fries — crispy and addictive.",
      image:
        "https://i.pinimg.com/736x/e1/fe/5d/e1fe5d75042f22074b9ec16f1db491f4.jpg",
      nutrition: { calories: 380, protein: 5, fats: 18, carbs: 50 },
      price: 140,
      mealTypes: ["Breakfast", "Lunch", "Dinner"],
      tag: "Must Try",
    },
  ...
  Alacarte: [
    ...
    {
      id: 11,
      name: "Chicken Skin with Rice & Drink",
      description: "Solo Meal.",
      image: "https://bit.ly/3P6DcAK",
      nutrition: { calories: 280, protein: 34, fats: 14, carbs: 5 },
      price: 78,
    ...
    {
      id: 12,
      name: "2 pcs. Chicken With Rice & Drink",
      description: "Solo Meal.",
      image: "https://bit.ly/4r5rfZI",
      nutrition: { calories: 280, protein: 34, fats: 14, carbs: 5 },
      price: 148,
    ...
    {
      id: 13,
      name: "3 pcs. Chicken With Rice & Drink",
      description: "Solo Meal.",
      image: "https://bit.ly/4r1CAtC",
      nutrition: { calories: 280, protein: 34, fats: 14, carbs: 5 },
      price: 188,
...
const ORDER_IMAGE_PLACEHOLDER = "https://via.placeholder.com/80x80?text=Order";
        ...
        <AnimatePresence mode="wait">
              ...
              >
                <div
                  style={{
                    ...
                    height: 1,
                    background:
                      "linear-gradient(90deg,transparent,rgba(245,200,66,0.22),transparent)",
                  }}
                />
                <div
                  style={{
                ...
                >
                  Order online and pick up your items at the store when it's
                  ready.
                </p>
                <div
                  style={{
              ...
              >
                <div
                  style={{
                    ...
                    height: 1,
                    background:
                      "linear-gradient(90deg,transparent,rgba(240,237,232,0.1),transparent)",
                  }}
                />
                <div
                  style={{
                ...
                >
                  Order for delivery through Foodpanda or Grab.
                </p>
                <div
                  style={{
                    display: "flex",
                ...
                <div
                  style={{
                    padding: "12px 0",
                    borderRadius: 12,
                    background: "rgba(249,159,4,0.07)",
                    border: "1px solid rgba(240,237,232,0.12)",
                    textAlign: "center" as const,
                    fontSize: 14,
                    fontWeight: 700,
                    color: "rgb(215,162,71)",
                  }}
                >
          ...
          {view === "delivery" && (
            ...
            >
              ...
              >
                Select a delivery app to continue
              </h3>
              <p
                style={{
                  fontSize: 13,
              ...
              >
                Clicking will open the app or website in a new tab.
              </p>
              <div
                style={{
                  display: "grid",
                ...
                {[
                  {
                    key: "foodpanda",
                    label: "FoodPanda",
                    desc: "Order via the FoodPanda app or website",
                  ...
                  },
                  {
                    key: "grab",
                    label: "Grab",
                    desc: "Order via the Grab app or website",
                  ...
                  <motion.a
                    ...
                    whileHover={{ borderColor: `rgba(${d.rgba},0.45)`, y: -3 }}
                    whileTap={{ scale: 0.97 }}
                    transition={SPG}
                    style={{
                      display: "flex",
                      ...
                      background: `rgba(${d.rgba},0.05)`,
                      border: `1px solid rgba(${d.rgba},0.2)`,
                      borderRadius: 18,
                  ...
                  >
                    <div
                      style={{
                        ...
                        right: 12,
                        height: 1,
                        background: `linear-gradient(90deg,transparent,rgba(${d.rgba},0.3),transparent)`,
                      }}
                    />
                    <p
                      style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 28px 32px" }}>
          <AnimatePresence initial={false}>
            {orders.length === 0 ? (
              ...
              >
                <span style={{ color: "rgba(240,237,232,0.2)" }}>
                  <IconEmptyClipboard />
                </span>
                <p
                  style={{
                ...
                >
                  ...
                  <br />
                  Finished orders will be saved here.
                </p>
              </motion.div>
            ) : (
              orders.map((order, oi) => {
                      ...
                      >
                        <span
                          style={{
                            fontSize: 10.5,
                            fontWeight: 800,
                            color: isOpen ? "#111" : "rgba(240,237,232,0.38)",
                          }}
                        >
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  ...
                                  borderRadius: "50%",
                                  overflow: "hidden",
                                  border: "1.5px solid rgba(14,12,10,0.9)",
                                  flexShrink: 0,
                                  marginLeft: ii > 0 ? -6 : 0,
                                  zIndex: order.items.length - ii,
                                }}
                              >
                                <img
                                  src={recipeImage}
                                ...
                                >
                                  <span
                                    style={{
                                      ...
                                      border:
                                        "1px solid rgba(240,237,232,0.09)",
                                    }}
                                  >
                                    ×{item.quantity}
                                  </span>
    ...
    <div style={{ marginBottom: 34, display: "grid", gap: 14 }}>
      ...
      {orders.length === 0 ? (
        ...
        >
          ...
          >
            No active pickup order yet. Once your payment is verified and your
            order is placed, your own order status will show here.
          </p>
        </div>
      ) : (
        orders.map((order) => (
          ...
          >
            ...
            >
              <div>
                ...
                >
                  <span
                    style={{ fontSize: 18, fontWeight: 900, color: "#f0ede8" }}
                  >
                    {order.orderNumber}
                  </span>
                  <span
              ...
              <div style={{ textAlign: "right" as const }}>
                ...
                <div
                  style={{ fontSize: 13, fontWeight: 700, color: "#f0ede8" }}
                >
                  {order.trackingStatus}
                </div>
              </div>
          ...
          return (
            <motion.button
              ...
              style={{
                ...
                border: active
                  ? "1.5px solid #f5c842"
                  : "1.5px solid rgba(240,237,232,0.12)",
                background: active
...
function VariantToggle({
  ...
  selected: "original" | "spicy";
  onChange: (v: "original" | "spicy") => void;
}) {
  return (
          ...
          <AnimatePresence initial={false}>
            {cart.length === 0 ? (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={SPG}
                style={{ textAlign: "center", paddingTop: 88 }}
              >
                <motion.div
                  animate={{ y: [0, -8, 0] }}
                  transition={{
        ...
        <AnimatePresence>
          {cart.length > 0 && (
            ...
            >
              ...
              >
                <span style={{ fontSize: 13, color: "rgba(240,237,232,0.4)" }}>
                  Total
                </span>
                <AnimatePresence mode="wait">
                  <motion.span
      ...
      >
        <motion.div
          ...
          style={{
            ...
            justifyContent: "center",
            margin: "0 auto 24px",
            boxShadow: "0 8px 28px rgba(245,200,66,0.3)",
            fontSize: 30,
          }}
        >
          ✓
    ...
    >
      <div
        style={{
          ...
          height: 2,
          background:
            "linear-gradient(90deg,transparent,rgba(245,200,66,0.18),transparent)",
          borderRadius: 2,
        }}
      />
      <div style={{ flex: 1 }}>
          ...
          {tagStyle && (
            <span
              style={{
                ...
                flexShrink: 0,
                marginTop: 3,
                border: `1px solid ${tagStyle.text}28`,
              }}
            >
              {recipe.tag}
            </span>
        ...
        {recipe.variant !== undefined && (
          <VariantToggle selected={variantSel} onChange={onVariantChange} />
        )}
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <motion.button
              ...
              style={{
                ...
                color: isFav ? "#f5c842" : "rgba(240,237,232,0.45)",
                border: `1px solid ${isFav ? "rgba(245,200,66,0.3)" : "rgba(240,237,232,0.1)"}`,
                borderRadius: 12,
                padding: "10px 18px",
                fontSize: 13,
                fontWeight: 600,
            ...
            <motion.button
              ...
              style={{
                ...
                alignItems: "center",
                gap: 7,
                background: justAdded ? "rgba(74,222,128,0.1)" : "#f5c842",
                color: justAdded ? "#4ade80" : "#111",
                border: justAdded ? "1px solid rgba(74,222,128,0.25)" : "none",
                borderRadius: 12,
                padding: "10px 22px",
                fontSize: 13,
                fontWeight: 700,
...
export default function Delicacy() {
  ...
  useEffect(() => {
    ...
    if (!raw) return;
    try {
      setPaymentSession(JSON.parse(raw) as PaymentSessionState);
    } catch {
  ...
  useEffect(() => {
    ...
    if (paymentState === "cancelled") {
      setDrawerOpen(true);
      setPaymentMessage(
        "GCash checkout was cancelled. You can try sending the payment again when you're ready.",
      );
      clearPaymentParam();
      return;
    }
    ...
    let parsedSession: PaymentSessionState | null = null;
    try {
      parsedSession = JSON.parse(raw) as PaymentSessionState;
    ...
    setDrawerOpen(true);
    setPaymentMessage(
      "Payment return detected. Verifying your GCash payment now...",
    );
    ...
    (async () => {
      try {
        const data = await api.get<{
          ...
          status: string;
          paymentReference: string | null;
        }>(`/orders/paymongo/checkout/${parsedSession!.checkoutSessionId}`);
        if (cancelled) return;
        setPaymentSession({
          ...parsedSession!,
          paid: data.paid,
        ...
        setPaymentMessage(
          data.paid
            ? "Payment confirmed. You can now click Place Order."
            : "Payment return detected, but PayMongo still shows it as pending. Please check again in a moment.",
        );
      } catch (error) {
        if (cancelled) return;
        console.error("Failed to auto-verify payment:", error);
        setPaymentMessage(
          "We detected your return from GCash, but could not verify the payment automatically. Please click Check Payment Status.",
        );
      } finally {
        clearPaymentParam();
      }
  ...
  useEffect(() => {
    ...
    if (!match)
      match = allRecipes.find(
        (r) =>
          r.name.trim().toLowerCase().includes(needle) ||
          needle.includes(r.name.trim().toLowerCase()),
      );
    if (!match) return;

    const matchCategory =
      Object.entries(RECIPES).find(([, recipes]) =>
      ...
      if (found)
        return prev.map((c) =>
          c.recipe.id === recipe.id
            ? { ...c, quantity: c.quantity + 1, flavors }
            : c,
        );
  ...
  const changeQty = (id: number, delta: number) => {
    ...
    setCart((prev) =>
      prev
        .map((c) =>
          c.recipe.id === id ? { ...c, quantity: c.quantity + delta } : c,
        )
  ...
  useEffect(() => {
    fetchCustomerOrders();
    if (!customerUserId) return;
    const timer = window.setInterval(fetchCustomerOrders, 5000);
  ...
  const handleSendPayment = async () => {
    ...
    try {
      ...
      const nextSession: PaymentSessionState = {
      ...
      setPaymentMessage(
        "GCash payment page opened. Finish the payment there, then come back here and click Check Payment Status.",
      );
      ...
      if (message.includes("PAYMONGO_SECRET_KEY is not configured")) {
        const fallbackReference = `TEST-BYPASS-${Date.now()}`;
        setPaymentSession({
          checkoutSessionId: fallbackReference,
          checkoutUrl: "",
          status: "bypassed",
          paid: true,
        ...
        setPaymentMessage(
          "paymongo is not configured yet so i will bypass this first okay, click mo lang place order",
        );
      } else {
        setPaymentMessage(
          "We could not start the GCash payment right now. Please try again.",
        );
      }
    } finally {
  ...
  const handleVerifyPayment = async () => {
    ...
    try {
      const data = await api.get<{
        ...
        status: string;
        paymentReference: string | null;
      }>(`/orders/paymongo/checkout/${paymentSession.checkoutSessionId}`);
      setPaymentSession({
        ...paymentSession,
        paid: data.paid,
        status: data.status,
      ...
      setPaymentMessage(
        data.paid
          ? "Payment confirmed. You can now click Place Order."
          : "Payment is still pending. Finish the GCash checkout, then check again.",
      );
    } catch (error) {
      console.error("Failed to verify payment:", error);
      setPaymentMessage(
        "We could not verify your payment yet. Please try again in a moment.",
      );
    } finally {
      setIsSubmitting(false);
    }
  ...
  const handlePlaceOrder = async () => {
    ...
    if (!paymentSession?.paid) {
      setPaymentMessage("Please complete and verify your GCash payment first.");
      return;
    }
    ...
    try {
      ...
      console.error("Failed to place paid order:", error);
      setPaymentMessage(
        "Your payment is done, but we could not place the order yet. Please try again.",
      );
    } finally {
      setIsSubmitting(false);
    }
  ...
  const handleLogout = () => {
    ["isAuthenticated", "authToken", "userName", "userRole", "userId"].forEach(
  ...
  return (
    ...
    >
      ...
      >
        {[
          { top: "-8%", left: "10%", w: 700, op: 0.05 },
          { top: "45%", right: "-8%", w: 520, op: 0.03 },
          { bottom: "-8%", left: "30%", w: 600, op: 0.04 },
        ].map((g, i) => (
          <div
            key={i}
            style={{
              ...
              height: g.w,
              borderRadius: "50%",
              background: `radial-gradient(circle,rgba(245,200,66,${g.op}) 0%,transparent 65%)`,
            }}
          />
        ))}
      </div>
      ...
      <motion.nav
        ...
        style={{
          ...
          top: 0,
          zIndex: 100,
          background: scrolled ? "rgba(14,12,10,0.96)" : "rgba(14,12,10,0.80)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <motion.button
            ...
            style={{
              ...
              border: `1px solid ${orderHistory.length > 0 ? "rgba(245,200,66,0.25)" : "rgba(240,237,232,0.12)"}`,
              color:
                orderHistory.length > 0 ? "#f5c842" : "rgba(240,237,232,0.42)",
              borderRadius: 10,
              width: 40,
              height: 40,
              cursor: "pointer",
          ...
          {CATEGORIES.map((cat) => (
            <motion.button
              ...
              style={{
                ...
                color:
                  activeCategory === cat ? "#f5c842" : "rgba(240,237,232,0.3)",
                padding: "13px 22px",
                position: "relative",
                whiteSpace: "nowrap" as const,
              }}
                          ...
                          <>
                            <motion.div
                              ...
                              animate={{
                                ...
                                scale: [0.96, 1.015, 1.01, 1.015, 1.01, 1],
                              }}
                              exit={{ opacity: 0 }}
                              ...
                              style={{
                                ...
                                boxShadow:
                                  "0 0 0 4px rgba(245,200,66,0.15), 0 0 48px rgba(245,200,66,0.3)",
                                pointerEvents: "none",
                                zIndex: 10,
                              }}
                            />
                            <motion.div
                              ...
                              style={{
                                ...
                                borderRadius: 24,
                                background:
                                  "linear-gradient(105deg,transparent 20%,rgba(245,200,66,0.18) 50%,transparent 80%)",
                                pointerEvents: "none",
                                zIndex: 11,
                              }}
                            />
              ...
              >
                <div
                  style={{
                    ...
                    height: 1,
                    background:
                      "linear-gradient(90deg,transparent,rgba(245,200,66,0.15),transparent)",
                  }}
                />
                <motion.div
                  whileHover={{ scale: 1.08 }}
